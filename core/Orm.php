...
abstract class Orm
{
    protected static $conn, $database, $pk = 'id';

    private $loadMethod, $loadData, $modifiedFields = [], $isNew = false;

    protected $parentObject, $ignoreKeyOnUpdate = true, $ignoreKeyOnInsert = true;
